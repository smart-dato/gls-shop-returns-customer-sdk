...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/gls-shop-returns-customer-sdk.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/gls-shop-returns-customer-sdk)
...
```bash
php artisan vendor:publish --tag="gls-shop-returns-customer-sdk-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="gls-shop-returns-customer-sdk-views"
```

## Usage

```php
$glsShopReturnsCustomer = new SmartDato\GlsShopReturnsCustomer();
echo $glsShopReturnsCustomer->echoPhrase('Hello, SmartDato!');
```
